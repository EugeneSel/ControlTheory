...
for i in range(-5, 6):
    x1, x2 = path_definition(phi = np.pi * i / 25)
...
for i in np.arange(100, 500, 50):
    x1, x2 = path_definition(N = i, K = 1000)
    plt.plot(x1, x2, label='v = %d' %i)
